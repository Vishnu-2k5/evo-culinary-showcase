...
export const menuCategories: MenuCategory[] = [
  ...
  },
  {
    ...
    icon: "🍣",
    items: [
      { id: "su-1", name: "Purple Dragon Roll (4 pcs)", description: "Mascarpone, sweet shiitake, spicy mayo, togarashi & pickled carrot", price: "₹395", isJain: false, category: "Sushi" },
      { id: "su-2", name: "Purple Dragon Roll (8 pcs)", description: "Mascarpone, sweet shiitake, spicy mayo, togarashi & pickled carrot", price: "₹555", isJain: false, category: "Sushi" },
      { id: "su-3", name: "Baby Corn Tempura Roll (4 pcs)", description: "Jalapeno, tobanjan, avocado, baby corn tempura, sesame", price: "₹395", isJain: false, category: "Sushi" },
      { id: "su-4", name: "Baby Corn Tempura Roll (8 pcs)", description: "Jalapeno, tobanjan, avocado, baby corn tempura, sesame", price: "₹555", isJain: false, category: "Sushi" },
      { id: "su-5", name: "Avocado Crunchy Sushi Roll (4 pcs)", description: "Avocado, spicy mayo, cream cheese, tempura", price: "₹375", isJain: false, category: "Sushi" },
      { id: "su-6", name: "Avocado Crunchy Sushi Roll (8 pcs)", description: "Avocado, spicy mayo, cream cheese, tempura", price: "₹525", isJain: false, category: "Sushi" },
      { id: "su-7", name: "Crispy Asparagus Roll (4 pcs)", description: "Tempura-fried asparagus, cream cheese, tanuki, spicy mayo", price: "₹375", isJain: false, category: "Sushi" },
      { id: "su-8", name: "Crispy Asparagus Roll (8 pcs)", description: "Tempura-fried asparagus, cream cheese, tanuki, spicy mayo", price: "₹525", isJain: false, category: "Sushi" },
      { id: "su-9", name: "Yakuza Blue Rice Roll (4 pcs)", description: "Crispy asparagus, avocado, cucumber, torched with cheese sauce", price: "₹395", isJain: false, category: "Sushi" },
      { id: "su-10", name: "Yakuza Blue Rice Roll (8 pcs)", description: "Crispy asparagus, avocado, cucumber, torched with cheese sauce", price: "₹555", isJain: false, category: "Sushi" },
      { id: "su-11", name: "Bellpepper Nigiri (4 pcs)", description: "Rice topped with a thin slice of Roasted Bellpepper", price: "₹395", isJain: false, category: "Sushi" },
      { id: "su-12", name: "Bellpepper Nigiri (8 pcs)", description: "Rice topped with a thin slice of Roasted Bellpepper", price: "₹555", isJain: false, category: "Sushi" },
      { id: "su-13", name: "Greenhouse California Roll (4 pcs) [J]", description: "Avocado, cucumber, lettuce, edamame & cream cheese", price: "₹395", isJain: true, category: "Sushi" },
      { id: "su-14", name: "Greenhouse California Roll (8 pcs) [J]", description: "Avocado, cucumber, lettuce, edamame & cream cheese", price: "₹555", isJain: true, category: "Sushi" },
    ],
  },
  {
    id: "bao",
