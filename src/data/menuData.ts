...
export const menuCategories: MenuCategory[] = [
  ...
  {
    id: "sushi-bao-dimsum",
    name: "Sushi, Bao & Dimsum",
    icon: "🍣",
    items: [
      { id: "sb-1", name: "Purple Dragon Roll (4 pcs)", description: "Mascarpone, sweet shiitake, spicy mayo, togarashi & pickled carrot", price: "₹395", isJain: false, category: "Sushi, Bao & Dimsum" },
      { id: "sb-2", name: "Purple Dragon Roll (6 pcs)", description: "Mascarpone, sweet shiitake, spicy mayo, togarashi & pickled carrot", price: "₹555", isJain: false, category: "Sushi, Bao & Dimsum" },
      { id: "sb-3", name: "Baby Corn Tempura Roll (4 pcs)", description: "Jalapeno, tobanjan, avocado, baby corn tempura, sesame", price: "₹395", isJain: false, category: "Sushi, Bao & Dimsum" },
      { id: "sb-4", name: "Baby Corn Tempura Roll (6 pcs)", description: "Jalapeno, tobanjan, avocado, baby corn tempura, sesame", price: "₹555", isJain: false, category: "Sushi, Bao & Dimsum" },
      { id: "sb-5", name: "Reshampatti Paneer Tikka Bao [J]", description: "Reshampatti chilli flavoured paneer & spicy chilli mayo", price: "₹425", isJain: true, category: "Sushi, Bao & Dimsum" },
      { id: "sb-6", name: "Mushrooms Chilli Bao", description: "Shiitake, black fungus, mushroom", price: "₹465", isJain: false, category: "Sushi, Bao & Dimsum" },
      { id: "sb-7", name: "Crispy Veggie Bao [J]", description: "Sweet chilli sauce & sesame", price: "₹425", isJain: true, category: "Sushi, Bao & Dimsum" },
      { id: "sb-8", name: "Truffle Edamame Purple Rice", description: "Purple rice combined with goodness of edamame beans", price: "₹375", isJain: false, category: "Sushi, Bao & Dimsum" },
      { id: "sb-9", name: "Spicy Basil Fried Rice", description: "Chilli & basil flavored rice tossed with mix veggies", price: "₹375", isJain: false, category: "Sushi, Bao & Dimsum" },
      { id: "sb-10", name: "Sticky Jasmine Rice", description: "Fragrant jasmine rice", price: "₹315", isJain: false, category: "Sushi, Bao & Dimsum" },
      { id: "sb-11", name: "Wok Tossed Veg Fried Rice", description: "Classic vegetable fried rice", price: "₹375", isJain: false, category: "Sushi, Bao & Dimsum" },
      { id: "sb-12", name: "Burnt Garlic Rice", description: "Aromatic burnt garlic flavored rice", price: "₹395", isJain: false, category: "Sushi, Bao & Dimsum" },
      { id: "sb-13", name: "Wok Tossed Hakka Noodles", description: "Classic Indo-Chinese noodles", price: "₹375", isJain: false, category: "Sushi, Bao & Dimsum" },
      { id: "sb-14", name: "Spicy Basil Noodles", description: "Thai style basil noodles", price: "₹395", isJain: false, category: "Sushi, Bao & Dimsum" },
      { id: "sb-15", name: "Phad Thai Noodles", description: "Authentic Thai street food", price: "₹405", isJain: false, category: "Sushi, Bao & Dimsum" },
      { id: "sb-16", name: "Veg Korean Style Ramen", description: "Korean inspired ramen bowl", price: "₹455", isJain: false, category: "Sushi, Bao & Dimsum" },
      { id: "sb-17", name: "Crystal Dumpling", description: "Asparagus, waterchesnut, celery, carrot", price: "₹425", isJain: false, category: "Sushi, Bao & Dimsum" },
      { id: "sb-18", name: "Edamame Truffle Dumpling", description: "Combination of edamame & aromatic truffle paste", price: "₹455", isJain: false, category: "Sushi, Bao & Dimsum" },
      { id: "sb-19", name: "Wild Mushroom Dim Sum", description: "Earthy flavours of wild mushrooms & cream cheese", price: "₹455", isJain: false, category: "Sushi, Bao & Dimsum" },
      { id: "sb-20", name: "Corn & Water Chestnut Dim Sum", description: "Sweet corn with crunchy water chestnuts", price: "₹425", isJain: false, category: "Sushi, Bao & Dimsum" },
      { id: "sb-21", name: "Exotic Veg Gyoza", description: "Pokchoy, carrot, beans, cauliflower", price: "₹425", isJain: false, category: "Sushi, Bao & Dimsum" },
      { id: "sb-22", name: "Avocado Crunchy Sushi Roll (4 pcs)", description: "Avocado, spicy mayo, cream cheese, tempura", price: "₹375", isJain: false, category: "Sushi, Bao & Dimsum" },
      { id: "sb-23", name: "Avocado Crunchy Sushi Roll (6 pcs)", description: "Avocado, spicy mayo, cream cheese, tempura", price: "₹525", isJain: false, category: "Sushi, Bao & Dimsum" },
      { id: "sb-24", name: "Crispy Asparagus Roll (4 pcs)", description: "Tempura-fried asparagus, cream cheese, tanuki, spicy mayo", price: "₹375", isJain: false, category: "Sushi, Bao & Dimsum" },
      { id: "sb-25", name: "Crispy Asparagus Roll (6 pcs)", description: "Tempura-fried asparagus, cream cheese, tanuki, spicy mayo", price: "₹525", isJain: false, category: "Sushi, Bao & Dimsum" },
      { id: "sb-26", name: "Yakuza Blue Rice Roll (4 pcs)", description: "Crispy asparagus, avocado, cucumber, torched with cheese sauce", price: "₹395", isJain: false, category: "Sushi, Bao & Dimsum" },
      { id: "sb-27", name: "Yakuza Blue Rice Roll (6 pcs)", description: "Crispy asparagus, avocado, cucumber, torched with cheese sauce", price: "₹555", isJain: false, category: "Sushi, Bao & Dimsum" },
      { id: "sb-28", name: "Bellpepper Nigiri (4 pcs)", description: "Rice topped with a thin slice of Roasted Bellpepper", price: "₹395", isJain: false, category: "Sushi, Bao & Dimsum" },
      { id: "sb-29", name: "Bellpepper Nigiri (6 pcs)", description: "Rice topped with a thin slice of Roasted Bellpepper", price: "₹555", isJain: false, category: "Sushi, Bao & Dimsum" },
      { id: "sb-30", name: "Greenhouse California Roll (4 pcs) [J]", description: "Avocado, cucumber, lettuce, edamame & cream cheese", price: "₹395", isJain: true, category: "Sushi, Bao & Dimsum" },
      { id: "sb-31", name: "Greenhouse California Roll (6 pcs) [J]", description: "Avocado, cucumber, lettuce, edamame & cream cheese", price: "₹555", isJain: true, category: "Sushi, Bao & Dimsum" },
    ],
  },
];
